...
<div>
  ...
  <!--banner end-->
  <div class="head_bar">
    <span>位置：</span><a href="${pageContext.request.contextPath}/index">首页 </a> > <span class="active">我的收藏</span>
  </div>
  <div class="comfor_con">
    <div class="top_tit">
      <span class="span1"><a href="comfortable.jsp">我的收藏</a></span><br/>
              ...
              <ul>
                ...
                <li>
                  <span class="icon-collection" aria-hidden="true" style="color: red">
                    <button class="Collection" onclick="location.href = '/collect?id=${pro.id}&type=3'">取消收藏</button>
                  </span>
                </li>
              </ul>
            </div>
